...
[![Release](https://github.com/Moleculez/English-assistant-chrome-extension/releases/latest/download/easy-english-reader-v0.1.0.zip)](#install)
...
- **Text-to-Speech** - Listen to the simplified text with configurable voice
...
2. **Click the purple button** that appears near your selection (or right-click and choose "Simplify in Easy English", or press `Ctrl+Shift+E`)
3. **Read the result** in the side panel — simplified text, explanation, and glossary
...
src/
  ...
  sidepanel/      # Side panel UI — streaming display, history, settings
...
- **LLM**: Streaming support via SSE/NDJSON for all providers
